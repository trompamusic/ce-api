...
class RequestControlActionCommand {
  ...
  _generateTemplateQuery (requestInput) {
    return [
      ...
      `potentialAction:{${QueryHelper.schemaTypeClause('ca')}, identifier:ca.identifier, name:ca.name, contributor:ca.contributor, title:ca.title, creator:ca.creator, source:ca.source, subject:ca.subject, format:ca.format, language:ca.language,`,
